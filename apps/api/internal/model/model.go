...
type Node struct {
	...
	Scope      string         `gorm:"size:16;index;default:'personal'" json:"scope"` // personal | public
	...
	CreatedBy  string         `gorm:"size:36;index" json:"createdBy,omitempty"`
	UpdatedBy  string         `gorm:"size:36;index" json:"updatedBy,omitempty"`
	LockOwner  string         `gorm:"size:36;index" json:"lockOwner,omitempty"`
...
// AISettings 用户级配置（每个用户一行）
type AISettings struct {
	ID       uint   `gorm:"primaryKey" json:"id"`
	OwnerID  string `gorm:"size:36;uniqueIndex" json:"ownerId,omitempty"`
