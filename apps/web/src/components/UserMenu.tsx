...
import { KeyRound, LogIn, LogOut, ShieldCheck, User as UserIcon, UserCog, UserPlus } from 'lucide-react'
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
export function UserMenu({ onUserManagement }: { onUserManagement?: () => void }) {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="min-w-[200px]">
          ...
          {user.role === 'admin' && onUserManagement && (
            <DropdownMenuItem onSelect={onUserManagement}>
